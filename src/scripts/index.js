...
const btnSubmitEditAvatar = formEditAvatar.querySelector(
  selectorsForm.submitButtonSelector
);
const inputAvatarSrc = formEditAvatar.querySelector(
  ".popup__form-input_type_avatar"
);

// Переменные модального окна изменения профиля
const popupEdit = document.querySelector(".popup_type_edit");
const formEdit = popupEdit.querySelector(".popup__form");
const btnSubmitEdit = formEdit.querySelector(
  selectorsForm.submitButtonSelector
);
